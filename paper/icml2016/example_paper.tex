...
\icmlauthor{Michael Eickenberg}{Michael.Eickenberg@nsup.org}
...
However, the effective dimensionality of neuroimaging data is
known to be low \cite{bzdok2015semi}.
This will be exploited by
injecting brain regions of functional specialization
and spatiotemporal interactions into the statistical estimation process.
%
...
\begin{table*}[]
\centering
\caption{18-class out-of-sample performance by region-network emphasis}

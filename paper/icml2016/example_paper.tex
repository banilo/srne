...
This enables recombination of
the neurobiological architectures underlying
functional segregation into brain regions and
functional integration by brain networks
that are routinely studied separately in neuroscientific research.
%
Region-network hierarchical priors for classifying
18 psychological tasks
from a reference dataset are
shown to outperform naive $\ell_1$-norm, elastic-net, and
...
The data loss function is approximated using an iterative forward-backward
...
extend the recently enabled tree dependencies.
%
Ultimately,

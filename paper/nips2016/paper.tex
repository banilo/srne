...
\begin{abstract}
  ...
  These priors bridge two levels of neurobiological architecture 
...
\textbf{\\keywords}: Sparsity-inducing norms, hierarchical tree sparsity,
...
% XXX are the compartments overlapping or not ?
...
That is, every variable carrying brain signals
...
and established region \cite{crad12} and network \cite{smith2009} atlases,
...
This notion of support recovery was computed by
Pearson correlation $corr$ (cf. results).
%
...
outcompeted other frequently used sparse penalization techniques
...
(\textit{from top to bottom}): tongue movement, listening to stories,
...
\begin{table*}[]
  ...
  \begin{tabular}{l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l}
    \textbf{Region-Network Ratio}          & 100   & 50    & 10   & 5     & 2    & 1     & $\frac{1}{2}$  & $\frac{1}{5}$  & $\frac{1}{10}$ & $\frac{1}{50}$ & $\frac{1}{100}$ \\ \hline
...
activity patterns covering extended parts of the brain (Barch et al., 2013).
%

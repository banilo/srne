...
explored with many different research methods.
%
...
Tissue lesion reports of the mid-fusiform gyrus of the visual system
frequently indicated impaired
recognition of others' identity from faces
\citep{iaria2008contribution}.
The localization of
...
neurotransmitter receptors rendered accessible yet another
local characteristic of neuronal populations
\citep{zilles2009receptor}.
% allude to our many-regions layer in the methods
In the computational era,
automatic clustering methods are increasingly employed to
regionally differentiation of the cerebral cortex,
which partly turned out to be more fine-grained than
classical cytoarchitectonic mapping
\citep{behrens03, cbp2015review}.
Today,
...
all these methodological classes
yielded neuroscientific findings
that were naturally interpreted
non-overlapping, discrete region compartments
as the basic architectonic framework of cortical organization.

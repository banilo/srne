...
As an extension to neuroscience,
network hierarchies of brain regions have been incorporated as priors into
brain imaging analysis.
This remarries the inextricable perspectives of
functional segregation and functional integration
that are routinely divorced in neuroscientific research.
%
Region-network hierarchical priors for logistic regression classification
in a reference dataset are
...
by structed sparsity principles.
